...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryGroup.auto_number'
        db.add_column('timepiece_entrygroup', 'auto_number',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryGroup.auto_number'
        db.delete_column('timepiece_entrygroup', 'auto_number')
