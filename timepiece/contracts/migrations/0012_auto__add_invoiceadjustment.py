...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvoiceAdjustment'
        db.create_table(u'contracts_invoiceadjustment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contracts.EntryGroup'])),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('line_item', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ...
        db.send_create_signal(u'contracts', ['InvoiceAdjustment'])


    def backwards(self, orm):
        # Deleting model 'InvoiceAdjustment'
        db.delete_table(u'contracts_invoiceadjustment')
