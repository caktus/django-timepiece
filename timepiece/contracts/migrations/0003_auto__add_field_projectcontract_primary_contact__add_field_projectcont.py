...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectContract.primary_contact'
        db.add_column('timepiece_projectcontract', 'primary_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=75, to=orm['crm.Contact']),
                      keep_default=False)

        # Adding field 'ProjectContract.payment_terms'
        db.add_column('timepiece_projectcontract', 'payment_terms',
                      self.gf('django.db.models.fields.CharField')(default='net30', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectContract.primary_contact'
        db.delete_column('timepiece_projectcontract', 'primary_contact_id')

        # Deleting field 'ProjectContract.payment_terms'
        db.delete_column('timepiece_projectcontract', 'payment_terms')
