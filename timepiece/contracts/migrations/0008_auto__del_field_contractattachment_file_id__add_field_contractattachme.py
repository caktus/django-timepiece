...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContractAttachment.file_id'
        db.delete_column(u'contracts_contractattachment', 'file_id')

        # Adding field 'ContractAttachment.bucket'
        db.add_column(u'contracts_contractattachment', 'bucket',
                      self.gf('django.db.models.fields.CharField')(default='aaceng-firmbase', max_length=64),
                      keep_default=False)

        # Adding field 'ContractAttachment.uuid'
        db.add_column(u'contracts_contractattachment', 'uuid',
                      self.gf('django.db.models.fields.TextField')(default='n/a'),
                      keep_default=False)


        # Changing field 'ContractAttachment.upload_datetime'
        db.alter_column(u'contracts_contractattachment', 'upload_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContractAttachment.file_id'
        raise RuntimeError("Cannot reverse this migration. 'ContractAttachment.file_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ContractAttachment.file_id'
        db.add_column(u'contracts_contractattachment', 'file_id',
                      self.gf('django.db.models.fields.CharField')(max_length=24),
                      keep_default=False)

        # Deleting field 'ContractAttachment.bucket'
        db.delete_column(u'contracts_contractattachment', 'bucket')

        # Deleting field 'ContractAttachment.uuid'
        db.delete_column(u'contracts_contractattachment', 'uuid')


        # Changing field 'ContractAttachment.upload_datetime'
        db.alter_column(u'contracts_contractattachment', 'upload_datetime', self.gf('django.db.models.fields.DateTimeField')())
