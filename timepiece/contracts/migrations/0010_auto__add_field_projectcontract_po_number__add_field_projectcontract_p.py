...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectContract.po_number'
        db.add_column('timepiece_projectcontract', 'po_number',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectContract.po_line_item'
        db.add_column('timepiece_projectcontract', 'po_line_item',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectContract.po_number'
        db.delete_column('timepiece_projectcontract', 'po_number')

        # Deleting field 'ProjectContract.po_line_item'
        db.delete_column('timepiece_projectcontract', 'po_line_item')
