...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContractAttachment'
        db.create_table(u'contracts_contractattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contracts.ProjectContract'])),
            ('file_id', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('upload_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('uploader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'contracts', ['ContractAttachment'])


    def backwards(self, orm):
        # Deleting model 'ContractAttachment'
        db.delete_table(u'contracts_contractattachment')
    ...
    models = {
        ...
        u'contracts.contractattachment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'upload_datetime': ('django.db.models.fields.DateTimeField', [], {}),
