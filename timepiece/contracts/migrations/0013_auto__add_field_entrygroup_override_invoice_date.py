...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryGroup.override_invoice_date'
        db.add_column('timepiece_entrygroup', 'override_invoice_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryGroup.override_invoice_date'
        db.delete_column('timepiece_entrygroup', 'override_invoice_date')
