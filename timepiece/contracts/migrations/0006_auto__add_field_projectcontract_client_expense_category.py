...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectContract.client_expense_category'
        db.add_column('timepiece_projectcontract', 'client_expense_category',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectContract.client_expense_category'
        db.delete_column('timepiece_projectcontract', 'client_expense_category')
