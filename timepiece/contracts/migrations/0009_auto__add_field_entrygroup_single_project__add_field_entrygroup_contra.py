...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryGroup.single_project'
        db.add_column('timepiece_entrygroup', 'single_project',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EntryGroup.contract'
        db.add_column('timepiece_entrygroup', 'contract',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contracts.ProjectContract'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'EntryGroup.project'
        db.alter_column('timepiece_entrygroup', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['crm.Project']))

    def backwards(self, orm):
        # Deleting field 'EntryGroup.single_project'
        db.delete_column('timepiece_entrygroup', 'single_project')

        # Deleting field 'EntryGroup.contract'
        db.delete_column('timepiece_entrygroup', 'contract_id')


        # Changing field 'EntryGroup.project'
        db.alter_column('timepiece_entrygroup', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default='default_val', to=orm['crm.Project']))
