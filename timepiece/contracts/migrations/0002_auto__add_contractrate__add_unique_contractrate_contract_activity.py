...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContractRate'
        db.create_table(u'contracts_contractrate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contracts.ProjectContract'])),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entries.Activity'])),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2)),
        ))
        db.send_create_signal(u'contracts', ['ContractRate'])

        # Adding unique constraint on 'ContractRate', fields ['contract', 'activity']
        db.create_unique(u'contracts_contractrate', ['contract_id', 'activity_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContractRate', fields ['contract', 'activity']
        db.delete_unique(u'contracts_contractrate', ['contract_id', 'activity_id'])

        # Deleting model 'ContractRate'
        db.delete_table(u'contracts_contractrate')
