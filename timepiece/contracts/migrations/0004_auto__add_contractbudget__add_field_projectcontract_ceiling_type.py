...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContractBudget'
        db.create_table(u'contracts_contractbudget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('budget', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=11, decimal_places=2)),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_budget', to=orm['contracts.ProjectContract'])),
        ...
        db.send_create_signal(u'contracts', ['ContractBudget'])

        # Adding field 'ProjectContract.ceiling_type'
        db.add_column('timepiece_projectcontract', 'ceiling_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ContractBudget'
        db.delete_table(u'contracts_contractbudget')

        # Deleting field 'ProjectContract.ceiling_type'
        db.delete_column('timepiece_projectcontract', 'ceiling_type')
    ...
    models = {
        ...
        u'contracts.contractbudget': {
            ...
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contract_budget'", 'to': u"orm['contracts.ProjectContract']"}),
        ...
        u'contracts.contracthour': {
            ...
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contract_hours'", 'to': u"orm['contracts.ProjectContract']"}),
            'date_approved': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_requested': ('django.db.models.fields.DateField', [], {}),
        ...
        u'contracts.projectcontract': {
            ...
            'ceiling_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
