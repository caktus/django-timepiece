...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContractNote'
        db.create_table(u'contracts_contractnote', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contracts.ContractNote'], null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'contracts', ['ContractNote'])


    def backwards(self, orm):
        # Deleting model 'ContractNote'
        db.delete_table(u'contracts_contractnote')
