...
urlpatterns = patterns('',
    ...
    url(r'^user/(?P<pk>\d+)/delete/$',
        ...
        name='delete_user'),
    url(r'^user/(?P<pk>\d+)/timesheet/$',
        views.view_user_timesheet,
        name='view_user_timesheet'),
    url(r'^user/(?P<pk>\d+)/timesheet/reject/$',
        views.reject_user_timesheet,
        name='reject_user_timesheet'),
    url(r'^user/(?P<pk>\d+)/timesheet/(?P<action>verify|approve)/$',
    ...
    url(r'^business/(?P<pk>\d+)/$',
        views.view_business,
        name='view_business'),
    url(r'^business/(?P<pk>\d+)/edit/$',
        views.create_edit_business,
        name='edit_business'),
    url(r'^business/(?P<pk>\d+)/delete/$',
    ...
    url(r'invoice/(?P<pk>\d+)/entries/(?P<entry_pk>\d+)/remove/$',
