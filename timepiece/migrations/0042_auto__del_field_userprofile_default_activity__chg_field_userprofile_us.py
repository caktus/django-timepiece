...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.default_activity'
        db.delete_column('timepiece_userprofile', 'default_activity_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.default_activity'
        db.add_column('timepiece_userprofile', 'default_activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Activity'], null=True, blank=True), keep_default=False)
