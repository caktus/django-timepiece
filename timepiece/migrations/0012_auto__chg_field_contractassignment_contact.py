...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContractAssignment.contact'
        db.alter_column('timepiece_contractassignment', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'ContractAssignment.contact'
        db.alter_column('timepiece_contractassignment', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
