...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonRepeatPeriod.user'
        db.add_column('timepiece_personrepeatperiod', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonRepeatPeriod.user'
        db.delete_column('timepiece_personrepeatperiod', 'user_id')
