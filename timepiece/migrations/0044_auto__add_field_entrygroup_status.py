...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntryGroup.status'
        db.add_column('timepiece_entrygroup', 'status', self.gf('django.db.models.fields.CharField')(default='invoiced', max_length=24), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EntryGroup.status'
        db.delete_column('timepiece_entrygroup', 'status')
