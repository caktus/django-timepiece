...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming 'trac_environment' field to 'tracker_url'
        db.rename_column('timepiece_project', 'trac_environment', 'tracker_url')        

    def backwards(self, orm):

        # Renaming 'tracker_url' field to 'trac_environment'
        db.rename_column('timepiece_project', 'tracker_url', 'trac_environment')        
    ...
    models = {
        ...
        'timepiece.project': {
            ...
            'tracker_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
