...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('timepiece_project', 'new_business_id', 'business_id')


    def backwards(self, orm):
        
        db.rename_column('timepiece_project', 'business_id', 'new_business_id')
    ...
    models = {
        ...
        'timepiece.project': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new_business_projects'", 'null': 'True', 'to': "orm['timepiece.Business']"}),
