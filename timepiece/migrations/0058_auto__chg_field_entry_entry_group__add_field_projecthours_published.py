...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.entry_group'
        db.alter_column('timepiece_entry', 'entry_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['timepiece.EntryGroup']))
        # Adding field 'ProjectHours.published'
        db.add_column('timepiece_projecthours', 'published',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entry.entry_group'
        db.alter_column('timepiece_entry', 'entry_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['timepiece.EntryGroup']))
        # Deleting field 'ProjectHours.published'
        db.delete_column('timepiece_projecthours', 'published')
