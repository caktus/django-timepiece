...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.billing_period'
        db.delete_column('timepiece_project', 'billing_period_id')


    def backwards(self, orm):
        
        # Adding field 'Project.billing_period'
        db.add_column('timepiece_project', 'billing_period', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', null=True, to=orm['timepiece.RepeatPeriod'], blank=True), keep_default=False)
