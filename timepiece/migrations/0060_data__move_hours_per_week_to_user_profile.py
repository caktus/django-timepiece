...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for profile in orm['timepiece.UserProfile'].objects.all():
            try:
                sched = orm['timepiece.PersonSchedule'].objects.get(user=profile.user)
            except:
                continue
            profile.hours_per_week = sched.hours_per_week
            profile.save()
