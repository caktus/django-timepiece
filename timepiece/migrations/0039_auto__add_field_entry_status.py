...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('timepiece_entry', 'status', self.gf('django.db.models.fields.CharField')(default='unverified', max_length=24), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.status'
        db.delete_column('timepiece_entry', 'status')
