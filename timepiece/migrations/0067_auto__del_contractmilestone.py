...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ContractMilestone'
        db.delete_table('timepiece_contractmilestone')


    def backwards(self, orm):
        # Adding model 'ContractMilestone'
        db.create_table('timepiece_contractmilestone', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(related_name='milestones', to=orm['timepiece.ProjectContract'])),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('hours', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('timepiece', ['ContractMilestone'])
