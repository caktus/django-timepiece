...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ProjectHours', fields ['project', 'week_start', 'user']
        db.create_unique('timepiece_projecthours', ['project_id', 'week_start', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProjectHours', fields ['project', 'week_start', 'user']
        db.delete_unique('timepiece_projecthours', ['project_id', 'week_start', 'user_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 17, 14, 18, 21, 37446)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 17, 14, 18, 21, 37351)'}),
