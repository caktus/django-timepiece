...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('timepiece_projecthours', 'timepiece_scheduleassignment')

    def backwards(self, orm):
        db.rename_table('timepiece_scheduleassignment', 'timepiece_projecthours')
    ...
    models = {
        ...
        'timepiece.scheduleassignment': {
            'Meta': {'unique_together': "(('week_start', 'project', 'user'),)", 'object_name': 'ScheduleAssignment'},
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
