...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.activity'
        db.alter_column('timepiece_entry', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Activity']))


    def backwards(self, orm):
        
        # Changing field 'Entry.activity'
        db.alter_column('timepiece_entry', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['timepiece.Activity']))
