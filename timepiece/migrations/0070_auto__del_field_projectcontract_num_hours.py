...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectContract.num_hours'
        db.delete_column('timepiece_projectcontract', 'num_hours')


    def backwards(self, orm):
        # Adding field 'ProjectContract.num_hours'
        db.add_column('timepiece_projectcontract', 'num_hours',
