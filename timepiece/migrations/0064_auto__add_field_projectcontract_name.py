...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectContract.name'
        db.add_column('timepiece_projectcontract', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Contract name', max_length=255),
                      keep_default=False)

        # Adding M2M table for field projects on 'ProjectContract'
        db.create_table('timepiece_projectcontract_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectcontract', models.ForeignKey(orm['timepiece.projectcontract'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting field 'ProjectContract.name'
        db.delete_column('timepiece_projectcontract', 'name')
