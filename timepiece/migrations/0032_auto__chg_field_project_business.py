...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('timepiece_project', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Business']))


    def backwards(self, orm):
        
        # Changing field 'Project.business'
        db.alter_column('timepiece_project', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['timepiece.Business']))
