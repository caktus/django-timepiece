...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Entry', fields ['end_time']
        db.create_index('timepiece_entry', ['end_time'])


    def backwards(self, orm):
        
        # Removing index on 'Entry', fields ['end_time']
        db.delete_index('timepiece_entry', ['end_time'])
