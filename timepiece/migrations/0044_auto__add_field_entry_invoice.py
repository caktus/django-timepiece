...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.invoice'
        db.add_column('timepiece_entry', 'invoice', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entries', null=True, to=orm['timepiece.Invoice']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.invoice'
        db.delete_column('timepiece_entry', 'invoice_id')
    ...
    models = {
        ...
        'timepiece.entry': {
            ...
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries'", 'null': 'True', 'to': "orm['timepiece.Invoice']"}),
        ...
        'timepiece.invoice': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invoice'", 'to': "orm['timepiece.Project']"}),
