...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('timepiece_activity', 'billable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Project.billable'
        db.add_column('timepiece_project', 'billable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.billable'
        db.delete_column('timepiece_activity', 'billable')
