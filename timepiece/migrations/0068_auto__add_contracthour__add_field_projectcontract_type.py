...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_contracthour', (
            ...
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_hours', to=orm['timepiece.ProjectContract'])),
        ...
        db.send_create_signal('timepiece', ['ContractHour'])

        # Adding field 'ProjectContract.type'
        db.add_column('timepiece_projectcontract', 'type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProjectContract.type'
        db.delete_column('timepiece_projectcontract', 'type')
