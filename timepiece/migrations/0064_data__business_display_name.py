...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Use the business's name as it's display name."""
        orm['timepiece.Business'].objects.filter(display_name='')\
                                         .update(display_name=models.F('name'))

    def backwards(self, orm):
        """Remove the display name from all Businesses."""
        orm['timepiece.Business'].objects.update(display_name='')
