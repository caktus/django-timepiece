...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContractAssignment.min_hours_per_week'
        db.add_column('timepiece_contractassignment', 'min_hours_per_week', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContractAssignment.min_hours_per_week'
        db.delete_column('timepiece_contractassignment', 'min_hours_per_week')
