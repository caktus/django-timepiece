...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.tracker_url'
        db.alter_column('timepiece_project', 'tracker_url', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Project.tracker_url'
        db.alter_column('timepiece_project', 'tracker_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
