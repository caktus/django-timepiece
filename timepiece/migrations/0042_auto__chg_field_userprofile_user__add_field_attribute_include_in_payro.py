...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('timepiece_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))

        # Adding field 'Attribute.include_in_payroll'
        db.add_column('timepiece_attribute', 'include_in_payroll', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'UserProfile.user'
        db.alter_column('timepiece_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))

        # Deleting field 'Attribute.include_in_payroll'
        db.delete_column('timepiece_attribute', 'include_in_payroll')
    ...
    models = {
        ...
        'timepiece.attribute': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'include_in_payroll': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'timepiece.userprofile': {
            ...
            'default_activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.Activity']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
