...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectRelationship.contact'
        db.alter_column('timepiece_projectrelationship', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Adding field 'ContractAssignment.user'
        db.add_column('timepiece_contractassignment', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assignments', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'ProjectRelationship.contact'
        db.alter_column('timepiece_projectrelationship', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Deleting field 'ContractAssignment.user'
        db.delete_column('timepiece_contractassignment', 'user_id')
