...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_userprofile', (
            ...
            ('default_activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Activity'], null=True, blank=True)),
        ))
        db.send_create_signal('timepiece', ['UserProfile'])
