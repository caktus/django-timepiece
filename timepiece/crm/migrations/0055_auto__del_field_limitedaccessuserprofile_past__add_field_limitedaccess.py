...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LimitedAccessUserProfile.past'
        db.delete_column(u'crm_limitedaccessuserprofile', 'past')

        # Adding field 'LimitedAccessUserProfile.hotel_brand'
        db.add_column(u'crm_limitedaccessuserprofile', 'hotel_brand',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'LimitedAccessUserProfile.pasts'
        db.add_column(u'crm_limitedaccessuserprofile', 'pasts',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LimitedAccessUserProfile.past'
        db.add_column(u'crm_limitedaccessuserprofile', 'past',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'LimitedAccessUserProfile.hotel_brand'
        db.delete_column(u'crm_limitedaccessuserprofile', 'hotel_brand')

        # Deleting field 'LimitedAccessUserProfile.pasts'
        db.delete_column(u'crm_limitedaccessuserprofile', 'pasts')
    ...
    models = {
        ...
        u'crm.userprofile': {
            ...
            'weekly_schedule': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'entries.activity': {
