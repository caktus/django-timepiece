...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityGoal.end_date'
        db.add_column(u'crm_activitygoal', 'end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 1, 26, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityGoal.end_date'
        db.delete_column(u'crm_activitygoal', 'end_date')
