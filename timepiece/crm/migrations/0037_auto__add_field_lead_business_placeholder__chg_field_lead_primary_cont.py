...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lead.business_placeholder'
        db.add_column(u'crm_lead', 'business_placeholder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Business'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Lead.primary_contact'
        db.alter_column(u'crm_lead', 'primary_contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'], null=True))

    def backwards(self, orm):
        # Deleting field 'Lead.business_placeholder'
        db.delete_column(u'crm_lead', 'business_placeholder_id')


        # User chose to not deal with backwards NULL issues for 'Lead.primary_contact'
        raise RuntimeError("Cannot reverse this migration. 'Lead.primary_contact' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Lead.primary_contact'
        db.alter_column(u'crm_lead', 'primary_contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact']))
