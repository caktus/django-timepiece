...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_opportunity', (
            ...
            ('differentiating_value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.DistinguishingValueChallenge'], null=True, blank=True)),
            ('proposal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.LeadAttachment'], null=True, blank=True)),
            ('proposal_status', self.gf('django.db.models.fields.CharField')(default='in-progress', max_length=16)),
            ('proposal_status_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['Opportunity'])

        # Adding M2M table for field project on 'Opportunity'
        m2m_table_name = db.shorten_name(u'crm_opportunity_project')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('opportunity', models.ForeignKey(orm[u'crm.opportunity'], null=False)),
            ('project', models.ForeignKey(orm[u'crm.project'], null=False))
        ))
        db.create_unique(m2m_table_name, ['opportunity_id', 'project_id'])


    def backwards(self, orm):
        # Deleting model 'Opportunity'
        db.delete_table(u'crm_opportunity')

        # Removing M2M table for field project on 'Opportunity'
        db.delete_table(db.shorten_name(u'crm_opportunity_project'))
