...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.billing_street_2'
        db.add_column('timepiece_business', 'billing_street_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Business.shipping_street_2'
        db.add_column('timepiece_business', 'shipping_street_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.billing_street_2'
        db.delete_column('timepiece_business', 'billing_street_2')

        # Deleting field 'Business.shipping_street_2'
        db.delete_column('timepiece_business', 'shipping_street_2')
