...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crm_contact', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['auth.User'], unique=True))

        # Adding field 'Milestone.author'
        db.add_column(u'crm_milestone', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, related_name='milestone_author', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Milestone.created'
        db.add_column(u'crm_milestone', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 9, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Milestone.editor'
        db.add_column(u'crm_milestone', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, related_name='milestone_editor', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Milestone.modified'
        db.add_column(u'crm_milestone', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 9, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Milestone.status'
        db.add_column(u'crm_milestone', 'status',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=8),
                      keep_default=False)

        # Adding field 'Milestone.approver'
        db.add_column(u'crm_milestone', 'approver',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='milestone_approver', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Milestone.approval_date'
        db.add_column(u'crm_milestone', 'approval_date',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contact.user'
        db.alter_column(u'crm_contact', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['auth.User']))
        
        # Deleting field 'Milestone.author'
        db.delete_column(u'crm_milestone', 'author_id')

        # Deleting field 'Milestone.created'
        db.delete_column(u'crm_milestone', 'created')

        # Deleting field 'Milestone.editor'
        db.delete_column(u'crm_milestone', 'editor_id')

        # Deleting field 'Milestone.modified'
        db.delete_column(u'crm_milestone', 'modified')

        # Deleting field 'Milestone.status'
        db.delete_column(u'crm_milestone', 'status')

        # Deleting field 'Milestone.approver'
        db.delete_column(u'crm_milestone', 'approver_id')

        # Deleting field 'Milestone.approval_date'
        db.delete_column(u'crm_milestone', 'approval_date')
    ...
    models = {
        ...
        u'crm.lead': {
            'Meta': {'ordering': "['status', 'title']", 'object_name': 'Lead'},
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'0-open'", 'max_length': '16'}),
        ...
        u'crm.limitedaccessuserprofile': {
            'Meta': {'object_name': 'LimitedAccessUserProfile'},
            'birthday_celebration': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'birthday_month': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'chipotle': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'coffee_shops': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'coffees': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'frequent_flyer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'gift_card': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'ground_transportation': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'hobbies': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'hotel': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'hotel_accommodatations': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'hotel_brand': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'other_gift': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'pasts': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'pizza': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'limited'", 'unique': 'True', 'to': u"orm['crm.UserProfile']"}),
            'rental_car': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'salad': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'sandwich': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'seating': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True'}),
            'snacks': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'soup': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'teas': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'crm.milestone': {
            'Meta': {'ordering': "('due_date',)", 'object_name': 'Milestone'},
            'approval_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'milestone_approver'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'milestone_author'", 'to': u"orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'milestone_editor'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'crm.opportunity': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'differentiating_value': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.DistinguishingValueChallenge']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_activity': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'lead': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Lead']"}),
            'project': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['crm.Project']", 'null': 'True', 'blank': 'True'}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.LeadAttachment']", 'null': 'True', 'blank': 'True'}),
            'proposal_status': ('django.db.models.fields.CharField', [], {'default': "'in-progress'", 'max_length': '16'}),
            'proposal_status_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'crm.paidtimeoffrequest': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '2'}),
            'approval_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pto_approver'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'processor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pto_processor'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'pto': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'crm.projectattachment': {
            'Meta': {'object_name': 'ProjectAttachment'},
        ...
        u'crm.userprofile': {
            ...
            'utilization': ('django.db.models.fields.FloatField', [], {'default': '80'}),
            'weekly_schedule': ('django.db.models.fields.CharField', [], {'default': "'0,0,0,0,0,0,0'", 'max_length': '128'})
        },
        u'entries.activity': {
