...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeadNote'
        db.create_table(u'crm_leadnote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lead', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Lead'])),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.LeadNote'], null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'crm', ['LeadNote'])

        # Adding model 'Lead'
        db.create_table(u'crm_lead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('aac_poc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead_poc', to=orm['auth.User'])),
            ('primary_contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead_created_by', to=orm['auth.User'])),
            ('last_editor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead_edited_by', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_activity', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['Lead'])

        # Adding M2M table for field contacts on 'Lead'
        m2m_table_name = db.shorten_name(u'crm_lead_contacts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lead', models.ForeignKey(orm[u'crm.lead'], null=False)),
            ('contact', models.ForeignKey(orm[u'crm.contact'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lead_id', 'contact_id'])


    def backwards(self, orm):
        # Deleting model 'LeadNote'
        db.delete_table(u'crm_leadnote')

        # Deleting model 'Lead'
        db.delete_table(u'crm_lead')

        # Removing M2M table for field contacts on 'Lead'
        db.delete_table(db.shorten_name(u'crm_lead_contacts'))
