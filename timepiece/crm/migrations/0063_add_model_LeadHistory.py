...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeadHistory'
        db.create_table(u'crm_leadhistory', (
        ...
        db.send_create_signal(u'crm', ['LeadHistory'])


    def backwards(self, orm):
        # Deleting model 'LeadHistory'
        db.delete_table(u'crm_leadhistory')
