...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DistinguishingValueChallenge.description'
        db.add_column(u'crm_distinguishingvaluechallenge', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DistinguishingValueChallenge.description'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'description')
