...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_department', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='other', max_length=16)),
        ))
        db.send_create_signal(u'crm', ['Department'])

        # Adding field 'UserProfile.department'
        db.add_column('timepiece_userprofile', 'department',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=16),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('timepiece_userprofile', 'department')
    ...
    models = {
        ...
        u'crm.approvedmilestone': {
            'Meta': {'ordering': "('project__code', 'milestone', '-approval_date')", 'object_name': 'ApprovedMilestone'},
            'approval_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'approved_milestone_approver'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approved_milestone_author'", 'to': u"orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approved_milestone_editor'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'milestone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approvals'", 'to': u"orm['crm.Milestone']"}),
        ...
        u'crm.department': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'other'", 'max_length': '16'})
        },
        ...
        u'crm.milestone': {
            'Meta': {'ordering': "('due_date', 'name')", 'object_name': 'Milestone'},
            'approval_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'crm.milestonenote': {
            'Meta': {'ordering': "['milestone', '-created_at']", 'object_name': 'MilestoneNote'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authored_milestone_notes'", 'to': u"orm['auth.User']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'crm.userprofile': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Business']"}),
            'department': ('django.db.models.fields.CharField', [], {'default': "'other'", 'max_length': '16'}),
