...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.assistant_phone'
        db.alter_column(u'crm_contact', 'assistant_phone', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'Contact.home_phone'
        db.alter_column(u'crm_contact', 'home_phone', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'Contact.fax'
        db.alter_column(u'crm_contact', 'fax', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'Contact.mobile_phone'
        db.alter_column(u'crm_contact', 'mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'Contact.other_phone'
        db.alter_column(u'crm_contact', 'other_phone', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'Contact.office_phone'
        db.alter_column(u'crm_contact', 'office_phone', self.gf('django.db.models.fields.CharField')(max_length=24))

    def backwards(self, orm):

        # Changing field 'Contact.assistant_phone'
        db.alter_column(u'crm_contact', 'assistant_phone', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Contact.home_phone'
        db.alter_column(u'crm_contact', 'home_phone', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Contact.fax'
        db.alter_column(u'crm_contact', 'fax', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Contact.mobile_phone'
        db.alter_column(u'crm_contact', 'mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Contact.other_phone'
        db.alter_column(u'crm_contact', 'other_phone', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Contact.office_phone'
        db.alter_column(u'crm_contact', 'office_phone', self.gf('django.db.models.fields.CharField')(max_length=16))
