...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactNote.contact'
        db.alter_column(u'crm_contactnote', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact']))

    def backwards(self, orm):

        # Changing field 'ContactNote.contact'
        db.alter_column(u'crm_contactnote', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Business']))
