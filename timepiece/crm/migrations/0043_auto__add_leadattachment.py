...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeadAttachment'
        db.create_table(u'crm_leadattachment', (
        ...
        db.send_create_signal(u'crm', ['LeadAttachment'])


    def backwards(self, orm):
        # Deleting model 'LeadAttachment'
        db.delete_table(u'crm_leadattachment')
