...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.client_primary_poc'
        db.alter_column('timepiece_project', 'client_primary_poc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Project.business_department'
        db.alter_column('timepiece_project', 'business_department_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['crm.BusinessDepartment']))

        # Changing field 'Project.activity_group'
        db.alter_column('timepiece_project', 'activity_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['entries.ActivityGroup']))

    def backwards(self, orm):

        # Changing field 'Project.client_primary_poc'
        db.alter_column('timepiece_project', 'client_primary_poc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'], null=True))

        # Changing field 'Project.business_department'
        db.alter_column('timepiece_project', 'business_department_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['crm.BusinessDepartment']))

        # Changing field 'Project.activity_group'
        db.alter_column('timepiece_project', 'activity_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entries.ActivityGroup']))
