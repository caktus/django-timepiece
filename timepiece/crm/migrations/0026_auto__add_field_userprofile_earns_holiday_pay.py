...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.earns_holiday_pay'
        db.add_column('timepiece_userprofile', 'earns_holiday_pay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.earns_holiday_pay'
        db.delete_column('timepiece_userprofile', 'earns_holiday_pay')
