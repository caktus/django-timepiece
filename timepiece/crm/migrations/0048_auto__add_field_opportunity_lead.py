...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opportunity.lead'
        db.add_column(u'crm_opportunity', 'lead',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, to=orm['crm.Lead']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opportunity.lead'
        db.delete_column(u'crm_opportunity', 'lead_id')
