...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Business.short_name'
        db.alter_column('timepiece_business', 'short_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=3))
        # Adding unique constraint on 'Business', fields ['short_name']
        db.create_unique('timepiece_business', ['short_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Business', fields ['short_name']
        db.delete_unique('timepiece_business', ['short_name'])


        # Changing field 'Business.short_name'
        db.alter_column('timepiece_business', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=255))
