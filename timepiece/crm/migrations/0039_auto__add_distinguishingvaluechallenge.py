...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DistinguishingValueChallenge'
        db.create_table(u'crm_distinguishingvaluechallenge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lead', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Lead'], null=True, blank=True)),
            ...
            ('longevity', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('due', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal(u'crm', ['DistinguishingValueChallenge'])


    def backwards(self, orm):
        # Deleting model 'DistinguishingValueChallenge'
        db.delete_table(u'crm_distinguishingvaluechallenge')
