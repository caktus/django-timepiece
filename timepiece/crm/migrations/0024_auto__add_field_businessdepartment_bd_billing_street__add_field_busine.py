...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessDepartment.bd_billing_street'
        db.add_column(u'crm_businessdepartment', 'bd_billing_street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_city'
        db.add_column(u'crm_businessdepartment', 'bd_billing_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_state'
        db.add_column(u'crm_businessdepartment', 'bd_billing_state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_postalcode'
        db.add_column(u'crm_businessdepartment', 'bd_billing_postalcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_mailstop'
        db.add_column(u'crm_businessdepartment', 'bd_billing_mailstop',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_country'
        db.add_column(u'crm_businessdepartment', 'bd_billing_country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_lat'
        db.add_column(u'crm_businessdepartment', 'bd_billing_lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_billing_lon'
        db.add_column(u'crm_businessdepartment', 'bd_billing_lon',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_street'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_city'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_state'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_postalcode'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_postalcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_mailstop'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_mailstop',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_country'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_lat'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessDepartment.bd_shipping_lon'
        db.add_column(u'crm_businessdepartment', 'bd_shipping_lon',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessDepartment.bd_billing_street'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_street')

        # Deleting field 'BusinessDepartment.bd_billing_city'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_city')

        # Deleting field 'BusinessDepartment.bd_billing_state'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_state')

        # Deleting field 'BusinessDepartment.bd_billing_postalcode'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_postalcode')

        # Deleting field 'BusinessDepartment.bd_billing_mailstop'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_mailstop')

        # Deleting field 'BusinessDepartment.bd_billing_country'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_country')

        # Deleting field 'BusinessDepartment.bd_billing_lat'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_lat')

        # Deleting field 'BusinessDepartment.bd_billing_lon'
        db.delete_column(u'crm_businessdepartment', 'bd_billing_lon')

        # Deleting field 'BusinessDepartment.bd_shipping_street'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_street')

        # Deleting field 'BusinessDepartment.bd_shipping_city'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_city')

        # Deleting field 'BusinessDepartment.bd_shipping_state'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_state')

        # Deleting field 'BusinessDepartment.bd_shipping_postalcode'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_postalcode')

        # Deleting field 'BusinessDepartment.bd_shipping_mailstop'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_mailstop')

        # Deleting field 'BusinessDepartment.bd_shipping_country'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_country')

        # Deleting field 'BusinessDepartment.bd_shipping_lat'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_lat')

        # Deleting field 'BusinessDepartment.bd_shipping_lon'
        db.delete_column(u'crm_businessdepartment', 'bd_shipping_lon')
