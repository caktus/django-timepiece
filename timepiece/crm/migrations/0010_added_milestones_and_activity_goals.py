...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityGoal'
        db.create_table(u'crm_activitygoal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('milestone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Milestone'])),
            ('activity', self.gf('django.db.models.fields.TextField')()),
            ('goal_hours', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
        ))
        db.send_create_signal(u'crm', ['ActivityGoal'])

        # Adding model 'Milestone'
        db.create_table(u'crm_milestone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'crm', ['Milestone'])


    def backwards(self, orm):
        # Deleting model 'ActivityGoal'
        db.delete_table(u'crm_activitygoal')

        # Deleting model 'Milestone'
        db.delete_table(u'crm_milestone')
    ...
    models = {
        ...
        u'crm.milestone': {
            'Meta': {'ordering': "('project', '-due_date')", 'object_name': 'Milestone'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
