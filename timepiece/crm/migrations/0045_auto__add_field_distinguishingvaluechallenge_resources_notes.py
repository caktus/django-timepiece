...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DistinguishingValueChallenge.resources_notes'
        db.add_column(u'crm_distinguishingvaluechallenge', 'resources_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DistinguishingValueChallenge.resources_notes'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'resources_notes')
