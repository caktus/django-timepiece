...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.business_department'
        db.add_column('timepiece_project', 'business_department',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='new_business_department_projects', null=True, to=orm['crm.BusinessDepartment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.business_department'
        db.delete_column('timepiece_project', 'business_department_id')
