...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaidTimeOffLog'
        db.create_table(u'crm_paidtimeofflog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('pto_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.PaidTimeOffRequest'], blank=True)),
        ))
        db.send_create_signal(u'crm', ['PaidTimeOffLog'])

        # Adding model 'PaidTimeOffRequest'
        db.create_table(u'crm_paidtimeoffrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.UserProfile'])),
            ('request_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('pto_date', self.gf('django.db.models.fields.DateField')()),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('approval_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
        ))
        db.send_create_signal(u'crm', ['PaidTimeOffRequest'])

        # Adding field 'UserProfile.employee_type'
        db.add_column('timepiece_userprofile', 'employee_type',
                      self.gf('django.db.models.fields.CharField')(default='inactive', max_length=24),
                      keep_default=False)

        # Adding field 'UserProfile.hire_date'
        db.add_column('timepiece_userprofile', 'hire_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.pto'
        db.add_column('timepiece_userprofile', 'pto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PaidTimeOffLog'
        db.delete_table(u'crm_paidtimeofflog')

        # Deleting model 'PaidTimeOffRequest'
        db.delete_table(u'crm_paidtimeoffrequest')

        # Deleting field 'UserProfile.employee_type'
        db.delete_column('timepiece_userprofile', 'employee_type')

        # Deleting field 'UserProfile.hire_date'
        db.delete_column('timepiece_userprofile', 'hire_date')

        # Deleting field 'UserProfile.pto'
        db.delete_column('timepiece_userprofile', 'pto')
    ...
    models = {
        ...
        u'crm.paidtimeofflog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pto_request': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.PaidTimeOffRequest']", 'blank': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.UserProfile']"})
        },
        u'crm.paidtimeoffrequest': {
            'Meta': {'ordering': "('user_profile', '-pto_date')", 'object_name': 'PaidTimeOffRequest'},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '2'}),
            'approval_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pto_date': ('django.db.models.fields.DateField', [], {}),
