...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.weekly_schedule'
        db.add_column('timepiece_userprofile', 'weekly_schedule',
                      self.gf('django.db.models.fields.CharField')(default='0.0,8.0,8.0,8.0,8.0,8.0,0.0', max_length=48),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.weekly_schedule'
        db.delete_column('timepiece_userprofile', 'weekly_schedule')
    ...
    models = {
        ...
        u'crm.userprofile': {
            ...
            'weekly_schedule': ('django.db.models.fields.CharField', [], {'max_length': '48'})
        },
        u'entries.activity': {
