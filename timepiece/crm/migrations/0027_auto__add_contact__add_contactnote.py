...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_contact', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='contact', unique=True, null=True, to=orm['auth.User'])),
            ('salutation', self.gf('django.db.models.fields.CharField')(max_length=8, blank=True)),
            ...
            ('office_phone', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('home_phone', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('other_phone', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('fax', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Business'], null=True, blank=True)),
            ('business_department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.BusinessDepartment'], null=True, blank=True)),
            ('assistant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'], null=True, blank=True)),
            ('assistant_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('assistant_phone', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('assistant_email', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('mailing_street', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('mailing_city', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('mailing_state', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('mailing_postalcode', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('mailing_mailstop', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('mailing_country', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('mailing_lat', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('mailing_lon', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('other_street', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('other_city', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('other_state', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('other_postalcode', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('other_mailstop', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('other_country', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('other_lat', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('other_lon', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('has_opted_out_of_email', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_opted_out_of_fax', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('do_not_call', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('birthday', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('lead_source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead_source', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'crm', ['Contact'])

        # Adding model 'ContactNote'
        db.create_table(u'crm_contactnote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Business'])),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.ContactNote'], null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'crm', ['ContactNote'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ContactNote'
        db.delete_table(u'crm_contactnote')
    ...
    models = {
        ...
        u'crm.contact': {
            ...
            'assistant_phone': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            ...
            'home_phone': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'mobile_phone': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'office_phone': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            ...
            'other_phone': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
        ...
        u'crm.contactnote': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Business']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edited': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
