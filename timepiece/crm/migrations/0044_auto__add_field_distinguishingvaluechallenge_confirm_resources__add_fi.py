...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DistinguishingValueChallenge.confirm_resources'
        db.add_column(u'crm_distinguishingvaluechallenge', 'confirm_resources',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.benefits_begin'
        db.add_column(u'crm_distinguishingvaluechallenge', 'benefits_begin',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.date_benefits_begin'
        db.add_column(u'crm_distinguishingvaluechallenge', 'date_benefits_begin',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.confirm'
        db.add_column(u'crm_distinguishingvaluechallenge', 'confirm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.confirm_notes'
        db.add_column(u'crm_distinguishingvaluechallenge', 'confirm_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.commitment'
        db.add_column(u'crm_distinguishingvaluechallenge', 'commitment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.commitment_notes'
        db.add_column(u'crm_distinguishingvaluechallenge', 'commitment_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DistinguishingValueChallenge.last_activity'
        db.add_column(u'crm_distinguishingvaluechallenge', 'last_activity',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DistinguishingValueChallenge.confirm_resources'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'confirm_resources')

        # Deleting field 'DistinguishingValueChallenge.benefits_begin'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'benefits_begin')

        # Deleting field 'DistinguishingValueChallenge.date_benefits_begin'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'date_benefits_begin')

        # Deleting field 'DistinguishingValueChallenge.confirm'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'confirm')

        # Deleting field 'DistinguishingValueChallenge.confirm_notes'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'confirm_notes')

        # Deleting field 'DistinguishingValueChallenge.commitment'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'commitment')

        # Deleting field 'DistinguishingValueChallenge.commitment_notes'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'commitment_notes')

        # Deleting field 'DistinguishingValueChallenge.last_activity'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'last_activity')
