...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityGoal.employee'
        db.add_column(u'crm_activitygoal', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_goals', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ActivityGoal.date'
        db.add_column(u'crm_activitygoal', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityGoal.employee'
        db.delete_column(u'crm_activitygoal', 'employee_id')

        # Deleting field 'ActivityGoal.date'
        db.delete_column(u'crm_activitygoal', 'date')
