...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LimitedAccessUserProfile'
        db.create_table(u'crm_limitedaccessuserprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='limited', unique=True, to=orm['crm.UserProfile'])),
            ('seating', self.gf('django.db.models.fields.CharField')(max_length=8, blank=True)),
            ('ground_transportation', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('hotel_accommodatations', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('frequent_flyer', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('rental_car', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('hotel', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('gift_card', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('coffee_shops', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('other_gift', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('coffees', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('teas', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('snacks', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('sandwich', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('soup', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('salad', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('pizza', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('past', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('chipotle', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('other', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('birthday_celebration', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('birthday_month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hobbies', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'crm', ['LimitedAccessUserProfile'])


    def backwards(self, orm):
        # Deleting model 'LimitedAccessUserProfile'
        db.delete_table(u'crm_limitedaccessuserprofile')
    ...
    models = {
        ...
        u'crm.limitedaccessuserprofile': {
            ...
            'past': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
