...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MilestoneNote'
        db.create_table(u'crm_milestonenote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('milestone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Milestone'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored_milestone_notes', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['MilestoneNote'])

        # Adding model 'ApprovedMilestone'
        db.create_table(u'crm_approvedmilestone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('milestone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='approved', to=orm['crm.Milestone'])),
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='approved_milestone_author', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='approved_milestone_editor', to=orm['auth.User'])),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='approved', max_length=8)),
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='approved_milestone_approver', null=True, to=orm['auth.User'])),
            ('approval_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['ApprovedMilestone'])


    def backwards(self, orm):
        # Deleting model 'MilestoneNote'
        db.delete_table(u'crm_milestonenote')

        # Deleting model 'ApprovedMilestone'
        db.delete_table(u'crm_approvedmilestone')
    ...
    models = {
        ...
        u'crm.approvedmilestone': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'milestone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approved'", 'to': u"orm['crm.Milestone']"}),
