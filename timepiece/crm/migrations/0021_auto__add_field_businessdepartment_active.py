...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessDepartment.active'
        db.add_column(u'crm_businessdepartment', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessDepartment.active'
        db.delete_column(u'crm_businessdepartment', 'active')
