...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.earns_pto'
        db.add_column('timepiece_userprofile', 'earns_pto',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PaidTimeOffRequest.pto'
        db.add_column(u'crm_paidtimeoffrequest', 'pto',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.earns_pto'
        db.delete_column('timepiece_userprofile', 'earns_pto')

        # Deleting field 'PaidTimeOffRequest.pto'
        db.delete_column(u'crm_paidtimeoffrequest', 'pto')
