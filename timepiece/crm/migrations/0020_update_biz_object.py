...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Business.account_number'
        db.add_column('timepiece_business', 'account_number',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Business.account_number'
        db.delete_column('timepiece_business', 'account_number')
