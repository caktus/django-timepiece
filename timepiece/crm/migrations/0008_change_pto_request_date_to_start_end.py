...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidTimeOffLog.date'
        db.alter_column(u'crm_paidtimeofflog', 'date', self.gf('django.db.models.fields.DateField')())
        # Deleting field 'PaidTimeOffRequest.pto_date'
        db.delete_column(u'crm_paidtimeoffrequest', 'pto_date')

        # Adding field 'PaidTimeOffRequest.pto_start_date'
        db.add_column(u'crm_paidtimeoffrequest', 'pto_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PaidTimeOffRequest.pto_end_date'
        db.add_column(u'crm_paidtimeoffrequest', 'pto_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PaidTimeOffLog.date'
        db.alter_column(u'crm_paidtimeofflog', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # User chose to not deal with backwards NULL issues for 'PaidTimeOffRequest.pto_date'
        raise RuntimeError("Cannot reverse this migration. 'PaidTimeOffRequest.pto_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PaidTimeOffRequest.pto_date'
        db.add_column(u'crm_paidtimeoffrequest', 'pto_date',
                      self.gf('django.db.models.fields.DateField')(),
                      keep_default=False)

        # Deleting field 'PaidTimeOffRequest.pto_start_date'
        db.delete_column(u'crm_paidtimeoffrequest', 'pto_start_date')

        # Deleting field 'PaidTimeOffRequest.pto_end_date'
        db.delete_column(u'crm_paidtimeoffrequest', 'pto_end_date')
