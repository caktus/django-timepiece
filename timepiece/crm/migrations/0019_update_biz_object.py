...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Business.billing_mailstop'
        db.add_column('timepiece_business', 'billing_mailstop',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Business.shipping_mailstop'
        db.add_column('timepiece_business', 'shipping_mailstop',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


        # Changing field 'Business.billing_country'
        db.alter_column('timepiece_business', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Business.billing_postalcode'
        db.alter_column('timepiece_business', 'billing_postalcode', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Business.shipping_country'
        db.alter_column('timepiece_business', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Business.shipping_postalcode'
        db.alter_column('timepiece_business', 'shipping_postalcode', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Business.billing_mailstop'
        db.delete_column('timepiece_business', 'billing_mailstop')

        # Deleting field 'Business.shipping_mailstop'
        db.delete_column('timepiece_business', 'shipping_mailstop')


        # Changing field 'Business.billing_country'
        db.alter_column('timepiece_business', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Business.billing_postalcode'
        db.alter_column('timepiece_business', 'billing_postalcode', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Business.shipping_country'
        db.alter_column('timepiece_business', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Business.shipping_postalcode'
        db.alter_column('timepiece_business', 'shipping_postalcode', self.gf('django.db.models.fields.CharField')(max_length=255))
