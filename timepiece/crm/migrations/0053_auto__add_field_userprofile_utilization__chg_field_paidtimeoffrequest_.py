...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.utilization'
        db.add_column('timepiece_userprofile', 'utilization',
                      self.gf('django.db.models.fields.FloatField')(default=80),
                      keep_default=False)


        # Changing field 'PaidTimeOffRequest.approver'
        db.alter_column(u'crm_paidtimeoffrequest', 'approver_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'PaidTimeOffRequest.processor'
        db.alter_column(u'crm_paidtimeoffrequest', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'UserProfile.utilization'
        db.delete_column('timepiece_userprofile', 'utilization')


        # Changing field 'PaidTimeOffRequest.approver'
        db.alter_column(u'crm_paidtimeoffrequest', 'approver_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'PaidTimeOffRequest.processor'
        db.alter_column(u'crm_paidtimeoffrequest', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
