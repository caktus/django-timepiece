...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityGoal.project'
        db.add_column(u'crm_activitygoal', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Project'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'ActivityGoal.milestone'
        db.alter_column(u'crm_activitygoal', 'milestone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Milestone'], null=True))

    def backwards(self, orm):
        # Deleting field 'ActivityGoal.project'
        db.delete_column(u'crm_activitygoal', 'project_id')


        # User chose to not deal with backwards NULL issues for 'ActivityGoal.milestone'
        raise RuntimeError("Cannot reverse this migration. 'ActivityGoal.milestone' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ActivityGoal.milestone'
        db.alter_column(u'crm_activitygoal', 'milestone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Milestone']))
