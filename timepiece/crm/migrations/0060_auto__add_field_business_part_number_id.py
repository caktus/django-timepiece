...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.part_number_id'
        db.add_column('timepiece_business', 'part_number_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.part_number_id'
        db.delete_column('timepiece_business', 'part_number_id')
    ...
    models = {
        ...
        u'crm.business': {
            ...
            'part_number_id': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
