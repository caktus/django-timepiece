...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TemplateDifferentiatingValue'
        db.create_table(u'crm_templatedifferentiatingvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('probing_question', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'crm', ['TemplateDifferentiatingValue'])

        # Adding field 'DistinguishingValueChallenge.probing_question'
        db.add_column(u'crm_distinguishingvaluechallenge', 'probing_question',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TemplateDifferentiatingValue'
        db.delete_table(u'crm_templatedifferentiatingvalue')

        # Deleting field 'DistinguishingValueChallenge.probing_question'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'probing_question')
