...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.pto_accrual'
        db.add_column('timepiece_userprofile', 'pto_accrual',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pto_accrual'
        db.delete_column('timepiece_userprofile', 'pto_accrual')
