...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidTimeOffLog.pto_request'
        db.alter_column(u'crm_paidtimeofflog', 'pto_request_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.PaidTimeOffRequest'], null=True))

        # Changing field 'PaidTimeOffRequest.approver'
        db.alter_column(u'crm_paidtimeoffrequest', 'approver_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PaidTimeOffLog.pto_request'
        raise RuntimeError("Cannot reverse this migration. 'PaidTimeOffLog.pto_request' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PaidTimeOffLog.pto_request'
        db.alter_column(u'crm_paidtimeofflog', 'pto_request_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.PaidTimeOffRequest']))

        # User chose to not deal with backwards NULL issues for 'PaidTimeOffRequest.approver'
        raise RuntimeError("Cannot reverse this migration. 'PaidTimeOffRequest.approver' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PaidTimeOffRequest.approver'
        db.alter_column(u'crm_paidtimeoffrequest', 'approver_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
