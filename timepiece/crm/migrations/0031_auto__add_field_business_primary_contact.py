...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.primary_contact'
        db.add_column('timepiece_business', 'primary_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='business_poc', null=True, to=orm['crm.Contact']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.primary_contact'
        db.delete_column('timepiece_business', 'primary_contact_id')
