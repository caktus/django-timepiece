...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('timepiece_userprofile', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crm.Business']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.business'
        db.delete_column('timepiece_userprofile', 'business_id')
