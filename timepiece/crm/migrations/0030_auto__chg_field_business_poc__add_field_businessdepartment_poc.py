...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Business.poc'
        db.alter_column('timepiece_business', 'poc_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'BusinessDepartment.poc'
        db.add_column(u'crm_businessdepartment', 'poc',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='business_department_poc', null=True, to=orm['crm.Contact']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Business.poc'
        raise RuntimeError("Cannot reverse this migration. 'Business.poc' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Business.poc'
        db.alter_column('timepiece_business', 'poc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'BusinessDepartment.poc'
        db.delete_column(u'crm_businessdepartment', 'poc_id')
    ...
    models = {
        ...
        u'crm.business': {
            ...
            'poc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'business_poc'", 'null': 'True', 'to': u"orm['auth.User']"}),
