...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessAttachment'
        db.create_table(u'crm_businessattachment', (
        ...
        db.send_create_signal(u'crm', ['BusinessAttachment'])


    def backwards(self, orm):
        # Deleting model 'BusinessAttachment'
        db.delete_table(u'crm_businessattachment')
