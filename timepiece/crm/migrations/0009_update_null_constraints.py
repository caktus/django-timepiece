...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaidTimeOffRequest.approval_date'
        db.alter_column(u'crm_paidtimeoffrequest', 'approval_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PaidTimeOffRequest.approval_date'
        raise RuntimeError("Cannot reverse this migration. 'PaidTimeOffRequest.approval_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PaidTimeOffRequest.approval_date'
        db.alter_column(u'crm_paidtimeoffrequest', 'approval_date', self.gf('django.db.models.fields.DateTimeField')())
