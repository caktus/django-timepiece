...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Business.num_of_employees'
        db.alter_column('timepiece_business', 'num_of_employees', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Business.num_of_employees'
        db.alter_column('timepiece_business', 'num_of_employees', self.gf('django.db.models.fields.FloatField')(null=True))
