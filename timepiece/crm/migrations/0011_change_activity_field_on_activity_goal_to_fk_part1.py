...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'crm_activitygoal', 'activity')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ActivityGoal.activity'
        raise RuntimeError("Cannot reverse this migration. 'ActivityGoal.activity' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ActivityGoal.activity'
