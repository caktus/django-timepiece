...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.hours_per_week'
        db.delete_column('timepiece_userprofile', 'hours_per_week')


    def backwards(self, orm):
        # Adding field 'UserProfile.hours_per_week'
        db.add_column('timepiece_userprofile', 'hours_per_week',
                      self.gf('django.db.models.fields.DecimalField')(default=40, max_digits=8, decimal_places=2),
                      keep_default=False)
