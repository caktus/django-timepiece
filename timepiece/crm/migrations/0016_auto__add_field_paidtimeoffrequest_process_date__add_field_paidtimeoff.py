...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaidTimeOffRequest.process_date'
        db.add_column(u'crm_paidtimeoffrequest', 'process_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PaidTimeOffRequest.processor'
        db.add_column(u'crm_paidtimeoffrequest', 'processor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pto_processor', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaidTimeOffRequest.process_date'
        db.delete_column(u'crm_paidtimeoffrequest', 'process_date')

        # Deleting field 'PaidTimeOffRequest.processor'
        db.delete_column(u'crm_paidtimeoffrequest', 'processor_id')
