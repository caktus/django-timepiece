...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.weekly_schedule'
        db.alter_column('timepiece_userprofile', 'weekly_schedule', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'UserProfile.weekly_schedule'
        db.alter_column('timepiece_userprofile', 'weekly_schedule', self.gf('django.db.models.fields.CharField')(max_length=48))
