...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.client_primary_poc'
        db.add_column('timepiece_project', 'client_primary_poc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.project_department'
        db.add_column('timepiece_project', 'project_department',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.client_primary_poc'
        db.delete_column('timepiece_project', 'client_primary_poc_id')

        # Deleting field 'Project.project_department'
        db.delete_column('timepiece_project', 'project_department')
    ...
    models = {
        ...
        u'crm.project': {
            ...
            'client_primary_poc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Contact']", 'null': 'True', 'blank': 'True'}),
