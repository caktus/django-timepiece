...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectAttachment'
        db.create_table(u'crm_projectattachment', (
        ...
        db.send_create_signal(u'crm', ['ProjectAttachment'])


    def backwards(self, orm):
        # Deleting model 'ProjectAttachment'
        db.delete_table(u'crm_projectattachment')
