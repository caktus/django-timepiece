...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DistinguishingValueChallenge.short_name'
        db.add_column(u'crm_distinguishingvaluechallenge', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DistinguishingValueChallenge.short_name'
        db.delete_column(u'crm_distinguishingvaluechallenge', 'short_name')
