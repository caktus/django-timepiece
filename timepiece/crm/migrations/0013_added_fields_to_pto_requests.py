...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaidTimeOffRequest.status'
        db.add_column(u'crm_paidtimeoffrequest', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=24),
                      keep_default=False)

        # Adding field 'PaidTimeOffRequest.approver_comment'
        db.add_column(u'crm_paidtimeoffrequest', 'approver_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaidTimeOffRequest.status'
        db.delete_column(u'crm_paidtimeoffrequest', 'status')

        # Deleting field 'PaidTimeOffRequest.approver_comment'
        db.delete_column(u'crm_paidtimeoffrequest', 'approver_comment')
