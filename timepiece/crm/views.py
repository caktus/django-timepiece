        ...
        if self.export_project_list:
            ...
            for project in project_list:
                ...
                row = [project.code, project.name, str(project.type),
                    ...
                    '%s %s - %s - %s' % (project.client_primary_poc.first_name, project.client_primary_poc.last_name, project.client_primary_poc.email, project.client_primary_poc.office_phone) if project.client_primary_poc else '',
