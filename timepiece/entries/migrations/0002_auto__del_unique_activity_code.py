...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Activity', fields ['code']
        db.delete_unique('timepiece_activity', ['code'])


    def backwards(self, orm):
        # Adding unique constraint on 'Activity', fields ['code']
        db.create_unique('timepiece_activity', ['code'])
