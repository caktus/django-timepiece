...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.writedown_user'
        db.add_column('timepiece_entry', 'writedown_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='writedown_user', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.writedown_user'
        db.delete_column('timepiece_entry', 'writedown_user_id')
    ...
    models = {
        ...
        u'contracts.entrygroup': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entry_group'", 'to': u"orm['crm.Project']"}),
        ...
        u'entries.entry': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': u"orm['entries.Activity']"}),
            'comments': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'entry_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['contracts.EntryGroup']"}),
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': u"orm['entries.Location']"}),
            'mechanism': ('django.db.models.fields.CharField', [], {'default': "'manual'", 'max_length': '24'}),
            'pause_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': u"orm['crm.Project']"}),
            'pto_log': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.PaidTimeOffLog']", 'null': 'True', 'blank': 'True'}),
            ...
            'writedown': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'writedown_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entries.Entry']", 'null': 'True', 'blank': 'True'}),
            'writedown_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'writedown_user'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'entries.location': {
