...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.writedown'
        db.add_column('timepiece_entry', 'writedown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Entry.writedown_entry'
        db.add_column('timepiece_entry', 'writedown_entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entries.Entry'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.writedown'
        db.delete_column('timepiece_entry', 'writedown')

        # Deleting field 'Entry.writedown_entry'
        db.delete_column('timepiece_entry', 'writedown_entry_id')
