...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.mechanism'
        db.add_column('timepiece_entry', 'mechanism',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=24),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.mechanism'
        db.delete_column('timepiece_entry', 'mechanism')
