...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.pto_log'
        db.add_column('timepiece_entry', 'pto_log',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.PaidTimeOffLog'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.pto_log'
        db.delete_column('timepiece_entry', 'pto_log_id')
