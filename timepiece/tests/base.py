...
from timepiece.models import Attribute, Business, Project, RelationshipType,\
        ProjectRelationship, Activity, ActivityGroup, Location, Entry,\
        UserProfile, ProjectHours
